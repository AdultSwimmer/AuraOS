...
# =========================
# APP SECRET
# Must match launcher.py exactly.
# Server rejects any request that doesn't include this.
# =========================
...
# =========================
# VERIFY SECRET
# Rejects anything not coming from the official .exe
# =========================
...
# =========================
# LOAD CORE
# Hardcoded. Non-negotiable. If this fails, everything stops.
# =========================
def load_core():
...
# =========================
# LOAD KNOWLEDGE
# Runs after core. Allowed to be empty.
# =========================
def load_knowledge():
...
# =========================
# LOG
# Server-side only. Never sent to users.
# =========================
...
# =========================
# BUILD OLLAMA PROMPT
# Takes the Anthropic-style request from the frontend,
# injects core + knowledge, converts conversation history
# into a single flat prompt that Ollama understands.
# =========================
def build_ollama_prompt(system, messages):

    # Full system block: core first, then knowledge, then user context
...
{system}"""
    ...
    # Flatten message history into a readable prompt
    conversation = ""
    for msg in messages:
...
# =========================
# SYSTEM BOOT
# Core must load first. Always. No exceptions.
# =========================
print("=" * 50)
...
# CHAT
#
# Receives Anthropic-style request from index.html:
#   { model, max_tokens, system, messages }
#
# Translates to Ollama format, sends to llama3,
# returns response shaped like Anthropic's so the
# frontend doesn't know or care about the difference.
# =========================
@app.route("/chat", methods=["POST"])
def chat():

    # Reject anything not coming from the official .exe
    ...
    try:
        ...
        # Return in Anthropic-style format so index.html parses it correctly
        return jsonify({
            "content": [
...
# =========================
# RUN
# 0.0.0.0 = accepts connections from outside, not just localhost
# =========================
